...
- `Sandstorm\FilamentKeycloakAdmin\Logging\KeycloakAdminLogger` — an optional container binding that lets
  a host app hand this package its own PSR-3 logger instance for the audit log above. Without a binding,
  no audit logging happens at all — there is no default channel fallback.
